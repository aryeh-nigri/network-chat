...
public class ClientWindow extends JFrame implements Runnable {
	...
	public ClientWindow(String name, String address, int port) {
		...
		String connectionMessage = "/c/" + name + "/e/";
		send(connectionMessage, false);
	...
	private void createWindow() {
		...
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				String disconnectMessage = "/d/" + client.getID() + "/e/";
...
//						String text = messageWithoutSpaces.substring(3, messageWithoutSpaces.length() - 3);
						console(text);
					} else if(message.startsWith("/i/")) {
						String timeOutMessage = "/i/" + client.getID() + "/e/";
						send(timeOutMessage, false);
					} else if(message.startsWith("/u/")) {
						String[] users = message.trim().substring(3).split("/n/");
